...
/**
 * U-Calm Aviation — LIVE Tailwind config.
 *
 ...
 * copies in `u-calm-brand-assets/06-Tailwind-Config.ts` (from the brand
 * book) are reference-only and are never auto-loaded.
 *
 * Per Brand Book v2.1: Deep Teal #2A8A98 is the primary; Serene Teal
 * #3BB5C7 is the brighter cousin used for dark mode and decorative
 * washes. Warm Champagne #BCB17A is the accent. Never red.
 */
